...
class _ListScreenState extends State<ListScreen> {
  ...
  Widget build(BuildContext context) {
    if (Storage.user['saved'] == null) Storage.user['saved'] = [];
    return new Scaffold(
      appBar: AppBar(
        title: Image.asset(
                ...
                return Padding(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        if (Storage.user['saved'].where((e){
                          return (e['category']== '${widget.cat}'&&
                              e['book_id']== ds['book_id']);
                        }).length==0)
                          Positioned(
                            top: 90.0,
                            left: 150.0,
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                if (!ds['likes'].contains(widget.uid)) {
                                  await Firestore.instance
                                      .collection('categories')
                                      .document(widget.cat)
                                      .collection('books')
                            ...
                            child: InkWell(
                              onTap: () async {
                                await Firestore.instance
                                  ...
                                  var predata = await transaction.get(Firestore
                                      .instance
                                      .collection('categories')
                                      .document(widget.cat)
                                      .collection('books')
